...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">{{ ADD_UNDER_CONSTRUCTION_PROPERTY }}</h1>

    <form action="{{ route('admin_underconstruction_property_store') }}" method="post" enctype="multipart/form-data">
        @csrf
