                ...
                <div class="row">
                    <div class="col-3">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="p3_tab" data-toggle="pill" href="#p3" role="tab"
                                aria-controls="p3" aria-selected="false">E-pin</a>
                    ...
                    <div class="col-9">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="p3" role="tabpanel" aria-labelledby="p3_tab">

                            <div class="form-group">
                                    <label for="">E-pin charge</label>
                                    <input type="text" name="e_pin_charge" class="form-control"
                                        value="{{ $setting->e_pin_charge }}">
                                </div>
                                <div class="form-group">
                                    <label for="">User id prefix</label>
                                    <input type="text" name="user_id_prefix" class="form-control"
                                        value="{{ $setting->user_id_prefix }}">
                                </div>
                                <!-- Tab Content -->
                                <!-- <div class="form-group">
