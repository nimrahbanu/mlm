        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @php $i=0; @endphp
                        @foreach($all_property_items as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('uploads/property_featured_photos/'.$row->property_featured_photo) }}" alt="" class="w_150">
                                </td>
                                <td>
                                    {{ $row->property_name }} <br>
                                    <a href="{{ route('front_property_detail',$row->property_slug) }}" class="badge badge-success" target="_blank">{{ SEE_DETAIL }}</a>
                                </td>
                                <td>
                                    @php
                                        $item_rating = 0;
                                        $item_review = '';
                                        $item_id = 0;
                                        $review_for_this = \App\Models\Review::where('property_id',$row->id)->where('agent_type','Admin')->where('agent_id',$user_detail->id)->first();
                            ...
                            <!-- Add Modal -->
                            <div class="modal fade modal_property_detail" id="add_review_modal{{ $i }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <!-- Update Modal -->
                            <div class="modal fade modal_property_detail" id="update_review_modal{{ $i }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
