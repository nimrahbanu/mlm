...
@section('admin_content')
    ...
    <form action="{{ route('language_admin_panel_text_store') }}" method="post">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        ...
                        <div class="float-right d-inline">
                            <a href="{{route('admin_language_admin_panel_text')}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> {{ VIEW_ALL }}</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
