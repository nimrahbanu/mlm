...
<div class="page-banner" style="background-image: url('{{ asset('uploads/page_banners/'.$page_other_item->customer_panel_page_banner) }}')">
	...
	<nav>
		<ol class="breadcrumb justify-content-center">
			...
			<li class="breadcrumb-item active">{{ ADD_PROPERTY }}</li>
		</ol>
	</nav>
</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				...
				@if($property_error_message != '')

				<span class="text-danger">{{ $property_error_message }}</span>

				@else
				<form action="{{ route('customer_property_add_store') }}" method="post" enctype="multipart/form-data">
                    @csrf
					<div class="row">
						<div class="col-md-12">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<textarea name="property_address" class="form-control h-70" cols="30" rows="10">{{ old('property_address') }}</textarea>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
                                <label for="">{{ MAP_IFRAME_CODE }}</label>
                                <textarea name="property_map" class="form-control h-70" cols="30" rows="10">{{ old('property_map') }}</textarea>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
                                ...
                                <input type="text" name="property_email" class="form-control" value="{{ old('property_email') }}">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
                                <label for="">{{ PHONE_NUMBER }}</label>
                                <input type="text" name="property_phone" class="form-control" value="{{ old('property_phone') }}">
							</div>
						</div>
					</div>
					<div class="row">
